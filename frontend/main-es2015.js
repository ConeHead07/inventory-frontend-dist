...
/* harmony import */ var _invent_form_modals_create_artikel_image_create_artikel_image_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./invent-form/modals/create-artikel-image/create-artikel-image.component */ "./src/app/invent-form/modals/create-artikel-image/create-artikel-image.component.ts");
/* harmony import */ var _invent_form_modals_show_artikel_image_show_artikel_image_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./invent-form/modals/show-artikel-image/show-artikel-image.component */ "./src/app/invent-form/modals/show-artikel-image/show-artikel-image.component.ts");
/* harmony import */ var _api_service__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./api.service */ "./src/app/api.service.ts");
/* harmony import */ var ngx_scanner_detection__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ngx-scanner-detection */ "./node_modules/ngx-scanner-detection/fesm2015/ngx-scanner-detection.js");
/* harmony import */ var _zxing_ngx_scanner__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! @zxing/ngx-scanner */ "./node_modules/@zxing/ngx-scanner/fesm2015/zxing-ngx-scanner.js");
/* harmony import */ var _invent_form_modals_scanner_scanner_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./invent-form/modals/scanner/scanner.component */ "./src/app/invent-form/modals/scanner/scanner.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _invent_form_modals_create_artikel_image_create_artikel_image_component__WEBPACK_IMPORTED_MODULE_24__["CreateArtikelImageComponent"],
            _invent_form_modals_show_artikel_image_show_artikel_image_component__WEBPACK_IMPORTED_MODULE_25__["ShowArtikelImageComponent"],
            _invent_form_modals_scanner_scanner_component__WEBPACK_IMPORTED_MODULE_29__["ScannerComponent"]
        ],
        imports: [
            ...
            _zxing_ngx_scanner__WEBPACK_IMPORTED_MODULE_28__["ZXingScannerModule"],
            ngx_scanner_detection__WEBPACK_IMPORTED_MODULE_27__["ScannerDetectionModule"],
        ],
        entryComponents: [
            _invent_form_modals_create_artikel_image_create_artikel_image_component__WEBPACK_IMPORTED_MODULE_24__["CreateArtikelImageComponent"],
            _invent_form_modals_show_artikel_image_show_artikel_image_component__WEBPACK_IMPORTED_MODULE_25__["ShowArtikelImageComponent"],
...
let DexieService = class DexieService extends dexie__WEBPACK_IMPORTED_MODULE_2__["default"] {
    constructor() {
        ...
        this.version(1).stores({
            ...
            inventar: 'ivid,mcid,rid,Bezeichnung,Typ,Kategorie,Farbe,Groesse,Zustand,Seriennr,' +
                'jobid,invid,iv_nr,ErsteAufnahmeAm,LetzteAufnahmeAm,' +
                'created_at,modified_at,created_uid,modified_uid',
            ...
            logInventar: '++id,crud_action,ivid,mcid,rid,mid,jobid,Bezeichnung,data,' +
                'log_time,log_user',
            ...
            logRaeume: '++id,crud_action,rid,gid,mid,Raum,Raumbezeichnung,Etage,data,' +
                'log_time,log_user,created_at,updated_at',
            mandanten: '++mid,Mandant,created_at,modified_at,created_uid,modified_uid',
            objektKatalogGlobal: '++gcid,hid,lid,Bezeichnung,Produktnr,Typ,Gruppe,Kategorie,Farbe,Groesse,' +
                'Bild,AnlagenNr,FibuNr,Flaeche,Gewicht,Baujahr,Kst,' +
                'created_at,modified_at,created_uid,modified_uid',
            objektKatalogMandant: '++mcid,gcid,mid,created_at,modified_at,created_uid,modified_uid',
            raeume: '++rid,gid,raumid,Raum,Raumbezeichnung,Etage,' +
                'created_at,modified_at,created_uid,modified_uid',
...
/* harmony import */ var _modals_scanner_scanner_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modals/scanner/scanner.component */ "./src/app/invent-form/modals/scanner/scanner.component.ts");
/* harmony import */ var _modals_create_artikel_image_create_artikel_image_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modals/create-artikel-image/create-artikel-image.component */ "./src/app/invent-form/modals/create-artikel-image/create-artikel-image.component.ts");
/* harmony import */ var _modals_show_artikel_image_show_artikel_image_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modals/show-artikel-image/show-artikel-image.component */ "./src/app/invent-form/modals/show-artikel-image/show-artikel-image.component.ts");
/* harmony import */ var _modals_select_create_artikel_select_create_artikel_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modals/select-create-artikel/select-create-artikel.component */ "./src/app/invent-form/modals/select-create-artikel/select-create-artikel.component.ts");
/* harmony import */ var _modals_select_create_raum_select_create_raum_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modals/select-create-raum/select-create-raum.component */ "./src/app/invent-form/modals/select-create-raum/select-create-raum.component.ts");
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], CreateArtikelImageComponent.prototype, "name", void 0);
...
let ScannerComponent = class ScannerComponent {
    ...
    activeModal) {
        ...
        this.formatsEnabled = [
            ...
            _zxing_library_esm_core_BarcodeFormat__WEBPACK_IMPORTED_MODULE_3__["default"].DATA_MATRIX,
            _zxing_library_esm_core_BarcodeFormat__WEBPACK_IMPORTED_MODULE_3__["default"].EAN_13,
            _zxing_library_esm_core_BarcodeFormat__WEBPACK_IMPORTED_MODULE_3__["default"].QR_CODE,
        ];
...
let DataService = class DataService {
    ...
    loadUserAssignedInventories() {
        this.api.get('api/inventur/listByAuthUser').subscribe((list) => {
            console.log('SelectInventoryComponent', 'loadUserAssignedInventories', { list });
    ...
    loadInventurDataByInventurId(id) {
        ...
        this.loadTableDataByUrl('gebaeude', `api/inventur/${id}/gebaeude`, tblStatus);
        this.loadTableDataByUrl('raeume', `api/inventur/${id}/raeume`, tblStatus);
        this.loadTableDataByUrl('inventar', `api/inventur/${id}/inventar`, tblStatus);
        this.loadTableDataByUrl('objektKatalogGlobal', `api/inventur/${id}/katalog`, tblStatus);
        this.loadTableDataByUrl('objektKatalogMandant', `api/inventur/${id}/artikelids`, tblStatus);
    }
...
let SelectInventoryComponent = class SelectInventoryComponent {
    ...
    ngOnInit() {
        ...
        this.dataService.getClientList2().then((result) => {
            console.log({ called: 'this.dataService.getClientList1', result });
            this.clients = result;
        });
    ...
    onSubmit() {
        ...
        this.dataService.loadInventurDataByInventurId(1);
