...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"modal-header\">\r\n  <h4 class=\"modal-title\">Neues aktuelles Raumfoto erstellen</h4>\r\n  <button type=\"button\" class=\"close\" aria-label=\"Close\" (click)=\"activeModal.dismiss('Cross click')\">\r\n    <span aria-hidden=\"true\">&times;</span>\r\n  </button>\r\n</div>\r\n<div class=\"modal-body\">\r\n  <!-- You can now use angular-cropper component in app.component.html -->\r\n  <input style=\"display:none\" type=\"file\" accept=\"image/*\" #inputUploadFile (change)=\"onInputImageFile($event, inputUploadFile)\" />\r\n  <input style=\"display:none\" type=\"file\"accept=\"image/*\" #inputUploadImage capture=\"camera\" (change)=\"onInputImageFile($event, inputUploadImage)\" />\r\n  <canvas id=\"prepareImgCanvas\" #prepareImgCanvas style=\"display:none;\"></canvas>\r\n\r\n  <div class=\"editor\" *ngIf=\"imageUrl\">\r\n    <div class=\"canvas\">\r\n      <angular-cropper\r\n        #angularCropper\r\n        *ngIf=\"imageUrl\"\r\n        [cropperOptions]=\"config\"\r\n        [imageUrl]=\"imageUrl\">\r\n      </angular-cropper>\r\n      <!--\r\n      (cropstart)=\"cropStart($event)\"\r\n      (crop)=\"onCrop($event)\"\r\n      (cropmove)=\"cropMove($event)\"\r\n      (cropend)=\"cropEnd($event)\"\r\n      (ready)=\"onCropperReady($event)\"\r\n      -->\r\n    </div>\r\n\r\n\r\n    <div class=\"toolbar-cropend\" *ngIf=\"cropStatus === 5\">\r\n      <button class=\"btn btn-sm btn-success btn-icon-cirular\" (click)=\"crop()\"><fa-icon [icon]=\"faCheck\"></fa-icon></button>\r\n      <button class=\"btn btn-sm btn-danger btn-icon-cirular\" (click)=\"cropReset()\"><fa-icon [icon]=\"faBan\"></fa-icon></button>\r\n    </div>\r\n    <div class=\"toolbar btn-group btn-group-sm rounded\">\r\n      <button class=\"btn btn-sm btn-light\" (click)=\"setDragModeToMove()\"><fa-icon [icon]=\"faMove\"></fa-icon></button>\r\n      <button class=\"btn btn-sm btn-light\" (click)=\"setDragModeToCrop()\"><fa-icon [icon]=\"faCrop\"></fa-icon></button>\r\n      <button class=\"btn btn-sm btn-light\" (click)=\"zoomIn()\"><fa-icon [icon]=\"faSearchPlus\"></fa-icon></button>\r\n      <button class=\"btn btn-sm btn-light\" (click)=\"zoomOut()\"><fa-icon [icon]=\"faSearchMinus\"></fa-icon></button>\r\n      <button class=\"btn btn-sm btn-light\" (click)=\"rotateLeft()\"><fa-icon [icon]=\"faRotateLeft\"></fa-icon></button>\r\n      <button class=\"btn btn-sm btn-light\" (click)=\"rotateRight()\"><fa-icon [icon]=\"faRotateRight\"></fa-icon></button>\r\n    </div>\r\n  </div>\r\n  <img *ngIf=\"previewImgUrl\" [src]=\"previewImgUrl\" class=\"mt-1\" style=\"max-width:100%; max-height:150px;\"/>\r\n  <p class=\"d-none\">create-artikel-image works!</p>\r\n</div>\r\n<div class=\"modal-footer\">\r\n  <div class=\"btn-toolbar\">\r\n    <div class=\"btn-group mr-5\">\r\n      <button class=\"btn btn-info\" (click)=\"openInputUploadFile()\">\r\n        <fa-icon [icon]=\"faUpload\"></fa-icon> Upload\r\n      </button>\r\n      <button class=\"btn btn-info\" (click)=\"openInputUploadImage()\">\r\n        <fa-icon [icon]=\"faCamera\"></fa-icon> Photo\r\n      </button>\r\n    </div>\r\n    <div class=\"btn-group\">\r\n\r\n      <button type=\"button\" class=\"btn btn-secondary\" (click)=\"close()\">Abbrechen</button>\r\n      <button type=\"button\" class=\"btn btn-success\" (click)=\"save()\" *ngIf=\"imageUrl\">\r\n        <fa-icon [icon]=\"faSave\"></fa-icon>\r\n        Fertig</button>\r\n    </div>\r\n  </div>\r\n</div>\r\n");
...
let AuthService = class AuthService {
    ...
    http, router, connection, baseData, apiService) {
        this.http = http;
        this.router = router;
        this.connection = connection;
        this.baseData = baseData;
    ...
    login(email, password) {
        ...
        const pwHash = crypto_js__WEBPACK_IMPORTED_MODULE_6__["SHA3"](pwSalt + password);
        const pwHashB64 = crypto_js__WEBPACK_IMPORTED_MODULE_6__["enc"].Base64.stringify(pwHash);
        ...
        return this.http.post(loginUrl, {
            ...
            this.handleAuthentication(email, resData.auth_identifier, resData.access_token, +resData.expires_in, +resData.clientDeviceId, pwHashB64);
        }));
    }
    ...
    setUserData(userData) {
        ...
        const logUserData = { user: this.user, userData: Object.assign({}, userData) };
    ...
    getUser() {
        ...
        console.log('getUser', { userData: Object.assign({}, userData) });
        if (userData &&
            ('email' in userData) &&
            ('id' in userData) &&
            ('uToken' in userData) &&
...
let ArtikelService = class ArtikelService {
    ...
    insertArtikelRefByGcidGcuuid(gcuuid) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const mcuuid = yield artikelRef.add(insertData);
    ...
    insertArtikelRef(daten) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const insertUuid = yield artikelRef.add(Object.assign({}, insertData, log));
...
let BarcodeService = class BarcodeService {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            switch (simpleResult.lookupResultTable) {
                ...
                case _shared_interfaces_dexie_interfaces__WEBPACK_IMPORTED_MODULE_3__["LookupResultTable"].Inventar:
                    console.log(`#245 fullLookup for ${barcode} fetch artikelRef/global/image/raum Data for ${lookupResultTableText}`, { mcuuid: simpleResult.inventar.mcuuid });
    ...
    rebuildTableByJobid(table, jobid) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.db.barcodeLookup.where({ table: tblName, for_jobid: jobid }).delete();
    ...
    addBarcode(item, log = false) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            return this.db.barcodeLookup.add(Object.assign({}, item, { log })).then((key) => key[0]);
        });
    }
    addError(err) {
...
let HerstellerService = class HerstellerService {
    ...
    create(name) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const uuid = guid_typescript__WEBPACK_IMPORTED_MODULE_4__["Guid"].create().toString();
            yield this.dexie.hersteller.add({
                Hersteller: name,
                uuid,
                for_jobid: jobid,
                created_at: new Date(),
...
let ImagesService = class ImagesService {
    ...
    insertArtikelImage(image, useJobid) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const rs = yield this.dexie.images.add(item).then((imgUuid) => {
    ...
    addImageKatalogRef(data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const devID = this.baseData.getCurrentDeviceId();
            const jobid = this.baseData.getCurrentJobid();
            const uuid = yield this.dexie.objektKatalogImages.add({
...
/* harmony import */ var _artikel_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./artikel.service */ "./src/app/pages/invent-form/data-services/artikel.service.ts");
/* harmony import */ var _hersteller_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./hersteller.service */ "./src/app/pages/invent-form/data-services/hersteller.service.ts");
/* harmony import */ var _shared_services_variables_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../shared/services/variables.service */ "./src/app/shared/services/variables.service.ts");
...
let InventarService = class InventarService {
    constructor(dexie, authService, baseData, herstellerService, artikelService, variablesService) {
        this.dexie = dexie;
        this.authService = authService;
        this.baseData = baseData;
        this.herstellerService = herstellerService;
    ...
    getFreshUuid() {
        return guid_typescript__WEBPACK_IMPORTED_MODULE_3__["Guid"].create().toString();
    }
    getNewKunstBarcode() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
    ...
    insertInventar(inventar, useJobid) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const log = { log: true };
            const insertUuid = yield this.dexie.inventar.add(Object.assign({}, item, log));
...
InventarService.ctorParameters = () => [
    ...
    { type: _shared_services_basedata_service__WEBPACK_IMPORTED_MODULE_4__["BasedataService"] },
    { type: _hersteller_service__WEBPACK_IMPORTED_MODULE_7__["HerstellerService"] },
    { type: _artikel_service__WEBPACK_IMPORTED_MODULE_6__["ArtikelService"] },
    { type: _shared_services_variables_service__WEBPACK_IMPORTED_MODULE_8__["VariablesService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let RaumService = class RaumService {
    ...
    updateByUuid(uuid, raum) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const numChanges = yield this.dexie.raeume.update(uuid, raum);
...
let InventFormComponent = class InventFormComponent {
    ...
    openCreateArtikelImage() {
        const modalRef = this.modalService.open(_modals_create_artikel_image_create_artikel_image_component__WEBPACK_IMPORTED_MODULE_11__["CreateArtikelImageComponent"]);
    ...
    openCreateRaumImage() {
        ...
        const modalRef = this.modalService.open(_modals_create_raum_image_create_raum_image_component__WEBPACK_IMPORTED_MODULE_33__["CreateRaumImageComponent"]);
        this.modalWatch(modalRef, 'CreateArtikelImage');
        modalRef.componentInstance.name = this.formInventar.Bezeichnung + '/' + this.formInventar.Typ;
        modalRef.componentInstance.gcuuid = this.formInventar.gcuuid;
        modalRef.componentInstance.setMetaData({
    ...
    openShowArtikelImage() {
        const modalRef = this.modalService.open(_modals_show_artikel_image_show_artikel_image_component__WEBPACK_IMPORTED_MODULE_12__["ShowArtikelImageComponent"]);
    ...
    openScanner(inputElm) {
        const modalRef = this.modalService.open(_modals_scanner_scanner_component__WEBPACK_IMPORTED_MODULE_10__["ScannerComponent"]);
    ...
    openSelectCreateArtikel(settings = null) {
        const modalRef = this.modalService.open(_modals_select_create_artikel_select_create_artikel_component__WEBPACK_IMPORTED_MODULE_8__["SelectCreateArtikelComponent"]);
    ...
    openSelectSearchArtikel() {
        const modalRef = this.modalService.open(_modals_select_search_artikel_select_search_artikel_component__WEBPACK_IMPORTED_MODULE_13__["SelectSearchArtikelComponent"]);
    ...
    openEditRaum() {
        const modalRef = this.modalService.open(_modals_edit_raum_edit_raum_component__WEBPACK_IMPORTED_MODULE_28__["EditRaumComponent"]);
    ...
    openEditInventar() {
        const modalRef = this.modalService.open(_modals_edit_inventar_edit_inventar_component__WEBPACK_IMPORTED_MODULE_30__["EditInventarComponent"]);
    ...
    openSelectCreateRaum() {
        const modalRef = this.modalService.open(_modals_select_create_raum_select_create_raum_component__WEBPACK_IMPORTED_MODULE_14__["SelectCreateRaumComponent"]);
    ...
    openRaumListDone(useRaum) {
        ...
        const modalRef = this.modalService.open(_modals_raum_list_done_raum_list_done_component__WEBPACK_IMPORTED_MODULE_16__["RaumListDoneComponent"]);
    ...
    openRaumListRest(useRaum) {
        const raum = useRaum || this.raum;
        const modalRef = this.modalService.open(_modals_raum_list_rest_raum_list_rest_component__WEBPACK_IMPORTED_MODULE_15__["RaumListRestComponent"]);
            ...
            switch (bcResult.lookupResultTable) {
                case _shared_interfaces_dexie_interfaces__WEBPACK_IMPORTED_MODULE_5__["LookupResultTable"].None:
                    ...
                    this.toastr.warning('Barcode: ' + barcode + '<br>' +
                        'Für eine Neuaufnahme weisen sie bitte einen Artikel zu!', 'Unbekannter Barcode');
                    break;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".editor {\n  height: 60%;\n  position: relative;\n}\n\n.canvas {\n  height: 100%;\n}\n\n.canvas {\n  align-items: center;\n  display: flex;\n  justify-content: center;\n}\n\n.toolbar-cropend,\n.toolbar {\n  bottom: 1rem;\n  color: #fff;\n  height: 2rem;\n  left: 50%;\n  margin-left: -8rem;\n  position: absolute;\n  width: 16rem;\n  z-index: 2015;\n}\n\n.toolbar {\n  background-color: rgba(0, 0, 0, 0.4);\n}\n\n.toolbar button {\n  background: transparent;\n  color: #fff;\n  border: 0;\n}\n\n.toolbar-cropend {\n  top: 1rem;\n  width: 5rem;\n  margin-left: -2.5rem;\n  z-index: 2016;\n  background-color: transparent;\n}\n\n.btn-icon-cirular {\n  width: 2rem;\n  height: 2rem;\n  border-radius: 1rem;\n}\n\n.btn-icon-cirular + .btn-icon-cirular {\n  margin-left: 1rem;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".editor {\n  height: 60%;\n  position: relative;\n}\n\n.canvas {\n  height: 100%;\n}\n\n.canvas {\n  align-items: center;\n  display: flex;\n  justify-content: center;\n}\n\n.toolbar-cropend,\n.toolbar {\n  bottom: 1rem;\n  color: #fff;\n  height: 2rem;\n  left: 50%;\n  margin-left: -8rem;\n  position: absolute;\n  width: 16rem;\n  z-index: 2015;\n}\n\n.toolbar {\n  background-color: rgba(0, 0, 0, 0.4);\n}\n\n.toolbar button {\n  background: transparent;\n  color: #fff;\n  border: 0;\n}\n\n.toolbar-cropend {\n  top: 1rem;\n  width: 5rem;\n  margin-left: -2.5rem;\n  z-index: 2016;\n  background-color: transparent;\n}\n\n.btn-icon-cirular {\n  width: 2rem;\n  height: 2rem;\n  border-radius: 1rem;\n}\n\n.btn-icon-cirular + .btn-icon-cirular {\n  margin-left: 1rem;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BhZ2VzL2ludmVudC1mb3JtL21vZGFscy9nZXNhbXQtbGlzdC1kb25lL2dlc2FtdC1saXN0LWRvbmUuY29tcG9uZW50LnNjc3MifQ== */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BhZ2VzL2ludmVudC1mb3JtL21vZGFscy9nZXNhbXQtbGlzdC1yZXN0L2dlc2FtdC1saXN0LXJlc3QuY29tcG9uZW50LnNjc3MifQ== */");
...
let ImageboxComponent = class ImageboxComponent {
    constructor(dexie, activeModal, domSanitizer) {
        this.dexie = dexie;
        this.activeModal = activeModal;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BhZ2VzL2ludmVudC1mb3JtL21vZGFscy9yYXVtLWxpc3QtZG9uZS9yYXVtLWxpc3QtZG9uZS5jb21wb25lbnQuc2NzcyJ9 */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BhZ2VzL2ludmVudC1mb3JtL21vZGFscy9yYXVtLWxpc3QtcmVzdC9yYXVtLWxpc3QtcmVzdC5jb21wb25lbnQuc2NzcyJ9 */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".card-body,\n.card-footer {\n  padding: 0.5rem;\n}\n\n.artikel-form .input-group-prepend .input-group-text {\n  min-width: 4rem;\n}\n\n.artikel-form.artikel-form-kunst .input-group-prepend .input-group-text {\n  min-width: 5.5rem;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".input-group-text {\n  min-width: 4rem;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BhZ2VzL2ludmVudC1mb3JtL21vZGFscy9zZWxlY3Qtc2VhcmNoLWFydGlrZWwvc2VsZWN0LXNlYXJjaC1hcnRpa2VsLmNvbXBvbmVudC5zY3NzIn0= */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BhZ2VzL2ludmVudC1mb3JtL21vZGFscy9zZWxlY3Qtc2VhcmNoLXJhdW0vc2VsZWN0LXNlYXJjaC1yYXVtLmNvbXBvbmVudC5zY3NzIn0= */");
...
let SelectInventoryComponent = class SelectInventoryComponent {
    constructor(dataService, route, router, auth, baseData, progressService, connection, dbsyncLogService) {
        this.dataService = dataService;
        this.route = route;
        this.router = router;
        this.auth = auth;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".app-navbar,\nnav.navbar {\n  background-color: #f2f2f2;\n}\n\nnav.navbar .navbar-brand img.logo {\n  width: 40vw;\n  max-width: 221px;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
let DexieService = class DexieService extends dexie__WEBPACK_IMPORTED_MODULE_2__["default"] {
    ...
    addChangeLog(change) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (change.type !== 3) {
                const obj = yield this.table(change.table).get(change.key);
                uuid = ('uuid' in obj) ? obj.uuid : '';
                delete obj.log;
                yield this.table(change.table).put(obj, change.key);
            }
            const chlog = {
                timestamp: new Date(),
                table: change.table,
                    ...
                    switch (change.table) {
                        case 'objektKatalogGlobal':
                            if (!('huuid' in chlog.mods)) {
                                chlog.mods.huuid = this.getChangeLogProp(change, 'huuid');
                            }
                            if (!('hid' in chlog.mods)) {
                                chlog.mods.hid = this.getChangeLogProp(change, 'hid');
                            }
                            break;
                        case 'objektKatalogMandant':
                            if (!('gcuuid' in chlog.mods)) {
                                chlog.mods.gcuuid = this.getChangeLogProp(change, 'gcuuid');
                            }
                            if (!('gcid' in chlog.mods)) {
                                chlog.mods.gcid = this.getChangeLogProp(change, 'gcid');
                            }
                            break;
                        case 'inventar':
                            if (!('mcuuid' in chlog.mods)) {
                                chlog.mods.mcuuid = this.getChangeLogProp(change, 'mcuuid');
                            }
                            if (!('ruuid' in chlog.mods)) {
                                chlog.mods.ruuid = this.getChangeLogProp(change, 'ruuid');
                            }
                            break;
                        default:
                        // Nothing
